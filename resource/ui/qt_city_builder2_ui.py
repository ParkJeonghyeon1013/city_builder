...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label__dd_grayscale = QLabel(self.groupBox__grayscale)
        self.label__dd_grayscale.setObjectName(u"label__dd_grayscale")

        self.horizontalLayout__dragdrop.addWidget(self.label__dd_grayscale)
        ...
        self.label__dd_osm = QLabel(self.groupBox__osm)
        self.label__dd_osm.setObjectName(u"label__dd_osm")

        self.horizontalLayout__osm_2.addWidget(self.label__dd_osm)
        ...
        self.label__img1 = QLabel(self.frame__img1)
        self.label__img1.setObjectName(u"label__img1")
        self.label__img1.setBaseSize(QSize(50, 50))
        font = QFont()
        font.setPointSize(36)
        self.label__img1.setFont(font)

        self.gridLayout_9.addWidget(self.label__img1, 0, 0, 1, 1)
        ...
        self.label__img2 = QLabel(self.frame__img2)
        self.label__img2.setObjectName(u"label__img2")
        self.label__img2.setBaseSize(QSize(50, 50))
        self.label__img2.setFont(font)

        self.gridLayout_11.addWidget(self.label__img2, 0, 0, 1, 1)
        ...
        self.label__img4 = QLabel(self.frame__img4)
        self.label__img4.setObjectName(u"label__img4")
        self.label__img4.setBaseSize(QSize(50, 50))
        self.label__img4.setFont(font)

        self.gridLayout_12.addWidget(self.label__img4, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label__dd_grayscale.setText(QCoreApplication.translate("MainWindow", u"Drag & Drop", None))
        ...
        self.label__dd_osm.setText(QCoreApplication.translate("MainWindow", u"Drag & Drop", None))
        ...
        self.label__img1.setText(QCoreApplication.translate("MainWindow", u"IMG 1              ", None))
        self.label__img2.setText(QCoreApplication.translate("MainWindow", u"IMG 1              ", None))
        self.label__img3.setText(QCoreApplication.translate("MainWindow", u"IMG 1              ", None))
        self.label__img4.setText(QCoreApplication.translate("MainWindow", u"IMG 1              ", None))
